...
os.makedirs('selected_models/small_model_wo_skip', exist_ok=True)

writer = SummaryWriter(log_dir="runs/selected_models/small_model_wo_skip")
...
for iter in range(max_iters):
    if iter % eval_interval == 0 or iter == max_iters - 1:
        ...
        torch.save(checkpoint, 'selected_models/small_model_wo_skip/latest_model.pth')
        
        # Save best model
        if val_loss < best_val_loss:
            best_val_loss = val_loss
            torch.save(checkpoint, 'selected_models/small_model_wo_skip/best_model.pth')
...
writer.close()
print("\nTraining complete! Models saved in 'selected_models/small_model_wo_skip' directory")
